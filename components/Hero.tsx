      ...
      <div className="max-w-6xl mx-auto px-6 pt-36 pb-28">
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-20 items-center">
          ...
          >
            ...
            <p className="text-[11px] tracking-[0.28em] uppercase text-white/35 mb-8">
            ...
            <div className="mb-8">
              <TypeAnimation
                ...
                speed={48}
                repeat={Infinity}
                className="text-5xl md:text-7xl font-semibold tracking-[-0.08em] leading-[0.95] text-white"
              />
            </div>
            ...
            <p className="max-w-xl text-[17px] leading-8 text-white/50 mb-12">
              ...
              systems, authentication workflows, API security, and production-ready
              MERN stack applications with clean architecture.
            </p>
            ...
            <div className="rounded-[28px] border border-white/[0.06] bg-[#111111] overflow-hidden">
              ...
              <div className="p-6 font-mono text-[13px] leading-7 overflow-hidden">
                ...
                <p className="text-white/35">
                  ...
                  <span className="ml-4 text-[#FCA5A5]">
                    // RBAC Middleware
                  </span>
                </p>
